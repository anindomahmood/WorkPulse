	...
	<div class="body">
		...
		<section class="section-1">
			...
			<div class="profile-card">
				...
				<div class="profile-row"><b>Full Name:</b> <?=htmlspecialchars($user['full_name'])?></div>
				<div class="profile-row"><b>Username:</b> <?=htmlspecialchars($user['username'])?></div>
				<div class="profile-row"><b>Role:</b> <?=htmlspecialchars(ucwords(str_replace('_',' ',$user['role'])))?></div>
				<div class="profile-row"><b>Joined:</b> <?=$user['created_at']?></div>
			</div>
