...
if (isset($_SESSION['role']) && isset($_SESSION['id']) && $_SESSION['role'] == "employee") {
    ...
    // mark everything as read once the employee opens this page
    $notificationModel->markAllAsRead($conn, $id);

    $notifications = $notificationModel->getMyNotifications($conn, $id);
...
<body>
	...
	<div class="body">
		...
		<section class="section-1">
			<h4 class="title" style="background:none;">Notifications</h4>
