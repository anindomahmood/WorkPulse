...
<body>
	...
	<div class="body">
		...
		<section class="section-1">
         ...
         <form class="form-1"
			      method="POST"
			      action="../Controller/UpdateProfileController.php">
      	  ...
      	  <?php } ?>
				...
				<div class="input-holder">
					...
					<input type="password" name="new_password" class="input-1" placeholder="New Password (leave blank to keep current)"><br>
				</div>
				<div class="input-holder">
